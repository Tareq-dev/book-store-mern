...
function DashHeaderCard() {
  return (
    <div className="grid grid-cols-3 gap-6 my-10 mr-4">
      <div className="px-6 py-6 relative max-w-[350px] text-white shadow bg-gradient-to-r overflow-hidden from-[#3b99f1] via-[#4FB5FF] to-[#4FB5FF] group rounded-md">
